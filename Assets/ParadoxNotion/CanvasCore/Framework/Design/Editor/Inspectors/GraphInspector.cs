...
namespace NodeCanvas.Editor
{
    ...
    public class GraphInspector : UnityEditor.Editor
    {
        ...
        private static readonly System.Reflection.FieldInfo ExternalSerializationFileField =
            typeof(Graph).GetField("_externalSerializationFile", System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.NonPublic);
            ...
            if ( graph.externalSerializationFile == null ) {
                if ( GUILayout.Button("Create External Serialization Text Asset") ) {
                    ...
                    if ( !string.IsNullOrEmpty(path) ) {
                        ...
                        SetExternalSerializationFile(AssetDatabase.LoadAssetAtPath<TextAsset>(path));
                    }
                }
            } else {
                SetExternalSerializationFile((TextAsset)EditorGUILayout.ObjectField("External Serialization File", graph.externalSerializationFile, typeof(TextAsset), true));
        ...
        void SetExternalSerializationFile(TextAsset asset) {
            if ( ExternalSerializationFileField != null ) {
                ExternalSerializationFileField.SetValue(graph, asset);
